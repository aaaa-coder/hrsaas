  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imageerror="require('@/assets/common/bigUserHeader.png')" :src="userInfo.staffPhoto">
          </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="showExceptDialog=true">申请离职</el-button>
    ...
    <!-- 弹出层 -->
    <el-dialog :visible="showExceptDialog" title="离职申请" @close="btnCancel">
      <el-form
        ref="exceptForm"
        :model="formData"
        status-icon
...
import Radar from './components/radar-echart'
...
export default {
  ...
  methods: {
    btnOK() {
      this.$refs.exceptForm.validate(async validate => {
        if (validate) {
    ...
    btnCancel() {
      this.showExceptDialog = false
      this.$refs.exceptForm.resetFields()
      this.formData = {
        reason: '',
        exceptTime: '',
        processKey: 'process_dimission', // 特定的审批
